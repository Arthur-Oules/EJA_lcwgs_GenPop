...
manhattan_lcwgs_coast_descending <- chromosome_names_desc_order |> 
  manhattan_plot_custom_2(chromosome_names_desc_order$pvalues_coast)
```
...
outliers_pos <- readRDS(
  file = here_d_lcwgs("manhattan_metadata.rds")
) |> 
...
manhattan_lcwgs_coast_descending_outliers <- chromosome_names_desc_order |> 
  manhattan_plot_custom_2(
    pvalues  = chromosome_names_desc_order$pvalues_coast,
    outliers = outliers_pos
  )

ggsave(
  here("output", "plots", "lcwgs", "manhattan_plot_custom_lcwgs_arranged_coast_outliers.png"),
