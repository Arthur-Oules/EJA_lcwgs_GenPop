...
Indiv_list |> 
  ...
  write_lines(here("plink2", "whitelist.txt"))
```
...
save_open_plot(
  here("output", "plots", "coast_manhattan.pdf"),
...
## Generating whitelist for SD *vs.* SC

```{r}
#| label: SDSCSaveWhitelist
#| eval: false
