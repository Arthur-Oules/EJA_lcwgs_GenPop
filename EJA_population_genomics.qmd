...
### Getting protein sequences for all loci analysis outliers
...
```{r}
pcadapt_blacklist_raw <- read.pcadapt(
  here(
    "data",
    "ustacks_populations_output",
    "EJA_blacklist",
...
### Getting outliers excluding Catalina
...
rm(
  nc_temp, nc_u, nc_v,
  lon, lat,
  crop_lonlat, crop_temp, crop_u_lowres, crop_v_lowres
...
```{r}
rm(map, states, sample_sites, states_labels, city_labels, ocean_labels, current_uv_scalar)
gc()
```
