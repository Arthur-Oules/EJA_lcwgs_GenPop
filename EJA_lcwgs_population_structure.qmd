...
saveRDS(lcwgs_gl, file = here("data", "Embiotoca_lcwgs_gl.rds"))
```
...
p3 <- mantel_plot(as.dist(geosphere::distm(coordinates)), Edward_distance, xlab = "Euclidean", ylab = "Chord distance")
...
p3 <- mantel_plot(as.dist(geosphere::distm(coordinates_coast_isj, fun = 
geosphere::distVincentyEllipsoid)), Edward_distance_coast_isj, xlab = "Ellipsoid Distance", ylab = " Cavalli-Sforza and Edward Chord Distance")
