...
ggsave(
  here("output", "plots", "manhattan_plot_custom_lcwgs_ncbi_islands.png"),
...
ggsave(
  here("output", "plots", "manhattan_plot_custom_lcwgs_ncbi_SD_SC.png"),
...
```{r}
save_open_plot(
  here("output", "plots", "pop_areas_K=7.png"),
  plot   = pop_area,
  width  = 9,
  height = 9
)
